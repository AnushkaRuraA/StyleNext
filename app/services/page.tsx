  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Salon Services</h1>
          <p className="text-gray-500 mt-1">Manage and view service catalogs across all salons.</p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {salonsWithServices.map((salon) => (
          <div key={salon.id} className="bg-card rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            {/* Salon Header */}
